...
#[ORM\Entity]
#[ORM\Table(name: 'sub_account_card')]
class SubAccountCard
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToOne(targetEntity: Account::class, inversedBy: 'subAccountCard')]
    ...
    /**
     * Ajouter un montant au sous-compte carte
     */
    ...
    /**
     * Débiter un montant du sous-compte carte
     */
    public function debit(string $amount): void
    {
        ...
        if ($debitAmount > $currentAmount) {
            throw new \Exception(sprintf(
                'Montant insuffisant dans le compte carte. Disponible: %.2f €, Demandé: %.2f €',
                $currentAmount,
                $debitAmount
            ));
        }
