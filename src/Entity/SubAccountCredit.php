...
#[ORM\Entity]
#[ORM\Table(name: 'sub_account_credit')]
class SubAccountCredit
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToOne(targetEntity: Account::class, inversedBy: 'subAccountCredit')]
    ...
    /**
     * Ajouter un montant au sous-compte crédit
     */
    ...
    /**
     * Débiter un montant du sous-compte crédit
     */
    public function debit(string $amount): void
    {
        ...
        if ($debitAmount > $currentAmount) {
            throw new \Exception(sprintf(
                'Montant insuffisant dans le compte crédit. Disponible: %.2f €, Demandé: %.2f €',
                $currentAmount,
                $debitAmount
            ));
        }
